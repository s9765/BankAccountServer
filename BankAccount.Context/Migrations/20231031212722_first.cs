    ...
    public partial class first : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccountsOfUser", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AccountsOfUser_Accounts_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AccountsOfUser_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccountsOfUser_AccountId",
                table: "AccountsOfUser",
                column: "AccountId");

            migrationBuilder.CreateIndex(
                name: "IX_AccountsOfUser_UserId",
                table: "AccountsOfUser",
                column: "UserId");
        }
